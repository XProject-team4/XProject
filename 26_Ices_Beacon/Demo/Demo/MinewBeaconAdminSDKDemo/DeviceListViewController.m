...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.detailTextLabel.text = [NSString stringWithFormat:@"Major:%ld Minor:%ld RSSI:%ld Battery:%ld", (long)beacon.major, (long)beacon.minor, (long)beacon.rssi, (long)beacon.battery];
